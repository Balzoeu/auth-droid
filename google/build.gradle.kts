import eu.balzo.authdroid.dependencies.Afollestad
import eu.balzo.authdroid.dependencies.AndroidX
import eu.balzo.authdroid.dependencies.Google
import eu.balzo.authdroid.dependencies.Kotlin
...
dependencies {
    ...
    implementation(Afollestad.inlineActivityResultCoroutine)
